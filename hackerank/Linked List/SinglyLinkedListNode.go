...
func insertNodeAtPosition(llist *SinglyLinkedListNode, data int32, position int32) *SinglyLinkedListNode {
	new_LinkedList := SinglyLinkedListNode{}
	new_LinkedList.data = data
	index := 0
	...
	new_LinkedList.next = currentNode.next
	currentNode.next = &new_LinkedList
	return llist
